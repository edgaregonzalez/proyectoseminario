...
export const listarIniciativasPorOrganizacion = async function(idOrganizacion) {
  // url
  let url = urlWebServices.listIniciativasPorOrganizacion.replace( /\:organizacion/, idOrganizacion);
